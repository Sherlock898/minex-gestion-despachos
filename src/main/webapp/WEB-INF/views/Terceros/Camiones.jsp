...
<body>
	...
	<div class="table-responsive small">
		<table id="camionesData" class="table table-striped table-sm text-center">
			<thead>
				<tr>
					<th>Id</th>
					<th>Patente</th>
			...
			<tbody>
				<c:forEach var="camion" items="${camiones}">
					<tr>
						...
						<c:if test="${usuario.rol == 'ADMIN'}">
							<td>
								<button type="button" class="btn btn-sm btn-outline-primary"  onclick="location.href = '/camiones/${camion.id}/edit'">Editar</button>
