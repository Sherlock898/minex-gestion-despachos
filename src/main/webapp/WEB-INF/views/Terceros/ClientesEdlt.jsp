...
<body>
	...
	<main class="col-md-9 ms-sm-auto col-lg-10 align-items-center">
		<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
			<h1 class="h2 mb-3">Editando cliente: ${cliente.nombre}</h1>

		</div>

		<div class="d-flex justify-content-center align-items-center">
			<form:form class="col-lg-9 col-sm-12 col-md-12 center-block" method="POST" action="/clientes/${cliente.id}/edit" modelAttribute="cliente">
				<form:input path="id" type="hidden"/>
				<form:input path="rut" type="hidden"/>
				<form:input path="razonSocial" type="hidden"/>
