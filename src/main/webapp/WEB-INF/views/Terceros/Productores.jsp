...
<body>
    ...
    <div class="sidebar d-flex flex-column flex-shrink-0 p-3 text-bg-dark col-md-3 col-lg-2 vh-100" >
		...
		<ul class="nav nav-pills flex-column mb-auto">
			...
			<li>
				<a href="/productores" class="nav-link text-white d-flex align-items-center active" aria-current="page">
					<svg class="bi pe-none me-2" width="16" height="16">
			...
			<li>
				<a href="/clientes" class="nav-link text-white d-flex align-items-center">
					<svg class="bi pe-none me-2" width="16" height="16">
		...
		<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
			...
			<div class="btn-toolbar mb-2 mb-md-0">
				...
				<c:if test="${usuario.rol == 'ADMIN'}">
					<button type="button" class="btn btn-sm btn-outline-secondary" onclick="location.href = '/productores/add'">Agregar</button>
				</c:if>
			</div>	
		</div>
	<div class="table-responsive small">
		<table id="productoresData" class="table table-striped table-sm text-center">
			<thead>
				<tr>
					<th>Id</th>
					<th>Rut</th>
			...
			<tbody>
				<c:forEach var="productor" items="${productores}">
					<tr>
						...
						<td>${productor.ciudadActual}</td>
						<td>${productor.comunaActual}</td>
						<td>${productor.direccionActual}</td>

						<c:if test="${usuario.rol == 'ADMIN'}">
							<td>
								<button type="button" class="btn btn-sm btn-outline-primary" onclick="location.href = '/productores/${productor.id}/edit'">Editar</button>
...
<script>
	...
	initializeDataTable('productoresData', 'copyClipboard', 'exportExcel', 6);
