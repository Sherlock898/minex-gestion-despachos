...
<body>
    ...
    <div class="sidebar d-flex flex-column flex-shrink-0 p-3 text-bg-dark col-md-3 col-lg-2 vh-100" >
		...
		<ul class="nav nav-pills flex-column mb-auto">
			...
			<li>
				<a href="/camiones" class="nav-link text-white d-flex align-items-center" aria-current="page">
					<svg class="pe-none me-2" width="16" height="16" stroke="#ffffff" fill="none">
	...
	<main class="col-md-9 ms-sm-auto col-lg-10">
		<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
			...
			<div class="btn-toolbar mb-2 mb-md-0">
				...
				<button type="button" class="btn btn-sm btn-outline-secondary" onclick="location.href = '/registro'">Agregar</button>
			</div>	
		</div>
	<div class="table-responsive small">
		<table id="usuariosData" class="table table-striped table-sm text-center">
			<thead>
				<tr>
					<th>Id</th>
					<th>Nombre</th>
			...
			<tbody>
				<c:forEach var="_usuario" items="${usuarios}">
					<tr>
						<th>${_usuario.id}</th>
						<td>${_usuario.nombre}</td>
						<td>${_usuario.email}</td>
						<td>${_usuario.rol}</td>
						<c:if test="${_usuario.rol == 'ADMIN'}">
							<td>
...
<script>
	...
	initializeDataTable('usuariosData', 'copyClipboard', 'exportExcel', 5);
